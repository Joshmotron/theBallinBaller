				...
				switch (file.split(".").slice(1).join(".")) {
					...
					case "entity.patch.json":
						if (fileContents.patchVersion === 6 && !validateEntityPatch(fileContents))
							return [
								false,
								"Invalid entity.patch.json file "
									.concat(file, " due to non-matching schema: ")
